...
export function OAuthButtons({ disabled = false, onError }: OAuthButtonsProps) {
  ...
  const buttonClass = "flex w-full items-center justify-center gap-3 rounded border border-white/15 bg-white/10 px-4 py-3 text-sm text-white transition hover:bg-white/15 disabled:cursor-not-allowed disabled:opacity-60";
...
export function OAuthDivider() {
  return (
    <div className="my-6 flex items-center gap-3 text-xs uppercase tracking-wide text-white/40">
